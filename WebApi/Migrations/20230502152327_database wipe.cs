...
{
    /// <inheritdoc />
    public partial class databasewipe : Migration
    {
        /// <inheritdoc />
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductWishlists", x => new { x.ProductsId, x.WishlistsId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductWishlists_Wishlists_WishlistsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerPromoCodes", x => new { x.CustomerProfilesId, x.PromoCodesId });
                    table.ForeignKey(
                        name: "FK_CustomerPromoCodes_CustomerProfiles_CustomerProfilesId",
                        column: x => x.CustomerProfilesId,
                        principalTable: "CustomerProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerPromoCodes_PromoCodes_PromoCodesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductWishlists_WishlistsId",
